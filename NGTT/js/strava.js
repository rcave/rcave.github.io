    ...
    $.ajax({
        ...
        success: function (data, response) {
            ...
            $.each(data, function (i, e) {
                ...
                var str = '<div class="activities"><img class="riderImage" src="' + riderImage + '"/><div class="riderInfo"><span class="riderName">' + firstName + ' ' + lastName + '</span><p>Activity Type: ' + actType + '</p><p>Distance: ' + fixedDist + ' mi</p><p>Avg Speed: ' + fixedSpd + ' mi/hr</p></div></div>';
